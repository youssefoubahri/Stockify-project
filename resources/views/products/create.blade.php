...
@section('title', 'Ajouter un Produit - Stockify')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold m-0">Nouveau Produit</h3>
        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="reference" id="reference" class="form-control @error('reference') is-invalid @enderror" value="{{ old('reference') }}" placeholder="Ex: PRD-001" required>
                    @error('reference')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Ex: Clavier Sans Fil" required>
                    @error('name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    <label for="quantity" class="form-label fw-semibold">Quantité Initiale</label>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="alert_stock" id="alert_stock" class="form-control @error('alert_stock') is-invalid @enderror" value="{{ old('alert_stock', 5) }}" required>
                    @error('alert_stock')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
